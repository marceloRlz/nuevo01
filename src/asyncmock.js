...
const stockProductos = [
    ...
    {id:'2' , nombre:'Pokemon  Ruby ', Precio:400, stock:7,descripcion:'Pokémon Edición Rubí y Pokémon Edición Zafiro, conocidos en Japón como Pocket Monsters Ruby & Sapphire, son 2 videojuegos del género RPG pertenecientes a la tercera generación de la saga Pokémon, y los primeros en su tipo lanzados para la consola portátil Game Boy Advance de Nintendo' ,img: "./img/juegos/poke-ruby.jpg",idCat:'2' },
